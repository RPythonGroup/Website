...
::: {.callout-note title="1단계: `Quarto_Website_Example` R프로젝트 만들기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="2단계: `.gitignore` 파일 수정하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="3단계: `Quarto_Website_Example` 원격저장소 만들기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="4단계: 원격저장소 연결하기" collapse="true" appearance="minimal"}
-   Github \<\> code 메뉴에서 Quick setup 내에 있는 URL이 원격저장소 주소입니다. 이를 이용하여 Terminal pane에서 아래의 git 명령어를 실행하여 원격저장소를 연결합니다.
-   아래는 예시이며 사용자마다 Guthub username이 다르므로 자신의 원격저장소 주소를 사용하셔야 합니다.
...
::: {.callout-note title="5단계: `index.qmd` 파일 이해하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="6단계: `_quarto.yml` 파일 이해하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="7단계: `style.css` 파일 이해하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="8단계: 버전관리 첫번째 복원시점 설정하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="9단계: Rendering과 메세지" collapse="true" appearance="minimal"}
-   Rendering에는 크게 2가지 방법이 있는데 아래의 그림처럼 `Source Pane`의 `Render button`을 실행하여 진행해 봅니다.
...
:::
![Render button in the RStudio IDE](images/RenderButton.JPG)

::: {.callout-note title="10단계: 출력폴더 변경하기" collapse="true" appearance="minimal"}
...
::: {.callout-note title="11단계: `index.qmd`에  내용 추가하기" collapse="true" appearance="minimal"}
...
- 추가한 이후에는 rjson, httr, plyr 패키지를 설치해야 합니다.
...
-   API를 호출은 이전 hands-on을 참고하시길 바랍니다.
:::
